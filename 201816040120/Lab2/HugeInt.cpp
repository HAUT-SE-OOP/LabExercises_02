...
{
    int i = 0;
    while (this->integer[i]==op2.integer[i])
    {
        i++;
    }
    return integer[i]==op2.integer[i]?true:false;
}
...
bool HugeInt::operator!=( const HugeInt &op2 )
{
    return (this->integer==op2.integer)?false:true;
}
...
bool HugeInt::operator<( const HugeInt &op2 )
{
    ...
    return (this->integer[i]<op2.integer[i])?true:false;
}
...
bool HugeInt::operator<=( const HugeInt &op2 )
{
    ...
    return (this->integer<op2.integer||this->integer==op2.integer)?true:false;
}
