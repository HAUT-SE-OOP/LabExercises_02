...
RationalNumber ::RationalNumber(int n,int d)//numerator and denominator;
{
    if(d<=0)
        d =1;
...
RationalNumber RationalNumber:: operator+(RationalNumber &x) const
{
    RationalNumber r;
    r.numerator = numerator * x.denominator + x.numerator * denominator;
...
RationalNumber RationalNumber:: operator/(RationalNumber &x) const
{
    RationalNumber r;
    if(x.numerator == 0)
        cout << "error:You can't divide by an zero"<<endl;
    else
    {
        r.numerator = numerator / x.numerator;
        r.denominator = denominator / x.denominator;
...
bool RationalNumber:: operator>(RationalNumber &x)
{
    ...
    b.numerator = a.denominator * b.numerator;
