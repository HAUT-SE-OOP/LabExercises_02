...
RationalNumber RationalNumber::operator+(const RationalNumber &right)
{
    ...
    if(denominator==right.denominator)
    {
        ...
        op.numerator=numerator+right.numerator;

    }
    else
    {
        int a=denominator*right.denominator;
        op.denominator=a;
        op.numerator=numerator*right.denominator+right.numerator*denominator;
    }
    op.reduction();
    return op;
}
...
{
    RationalNumber op;
    op.denominator=denominator*right.denominator;
    op.numerator=numerator*right.numerator;
    op.reduction();
    return op;
}
...
RationalNumber RationalNumber::operator/(const RationalNumber &right)
{
    ...
    {
        op.denominator=denominator*right.numerator;
        op.numerator=numerator*right.denominator;
        op.reduction();
    }
