...
{
    RationalNumber temp;
    temp.numerator=numerator*n.denominator+n.numerator*denominator;
...
{
    RationalNumber temp;
    temp.numerator=numerator*n.numerator;
    temp.denominator=denominator*n.denominator;
    temp.reduction();
    return temp;
}
...
RationalNumber RationalNumber::operator/(const RationalNumber &n)
{
    ...
    temp.denominator=denominator*n.numerator;
    temp.reduction();
    return temp;
}
// overloaded > operator
/* Write definition for operator > */
bool RationalNumber::operator>(const RationalNumber &n)
{
