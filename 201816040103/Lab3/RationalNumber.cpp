...
{
   a=denominator*right.denominator;
   b=numerator*right.denominator;
   c=right.numerator*denominator;
   if((b+c)/a>0)
	  return RationalNumber((b+c)/((b+c)/a),a/((b+c)/a));
   else
   	  return RationalNumber((b+c),a);
}
// overloaded - operator
/* Write definition for overloaded operator - */
RationalNumber RationalNumber::operator-(RationalNumber &right)
...
RationalNumber RationalNumber::operator*(RationalNumber &right)
{
   ...
   a*=right.numerator,b*=right.denominator;
...
{
   int a=numerator,b=denominator;
   a*=right.denominator,b*=right.numerator;
   return RationalNumber(a,b);
}
// overloaded > operator
